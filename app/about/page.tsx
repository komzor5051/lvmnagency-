...
const faq = [
  ...
  },
  {
    ...
    a: "Да. Бесплатный аудит на сайте: 7 вопросов, 5 минут, карта точек, где Claude/Codex окупится. Если нужен разбор конкретной задачи, есть час один на один за 3850 ₽.",
  },
  {
