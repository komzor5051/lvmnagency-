      ...
      <section className="bento-section" id="products">
        <div className="studio-frame">
          <header className="bento-head" data-studio-reveal>
            ...
            <h2>С чего начать</h2>
            <p>
              От гайда за 990 ₽ до внедрения под ключ. Два гайда закрывают разные
              задачи: один про Claude в работе, второй про контент-конвейер.
              Форматы не связаны между собой — начать можно с любого и
              остановиться на нём же.
            </p>
          </header>
