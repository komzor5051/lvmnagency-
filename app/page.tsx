...
const BIO = [
  "Занимаюсь AI с 2022 года. До этого — работа с клиентами и развитие собственного SaaS.",
  "За это время провёл 40+ внедрений: от автоматизации поддержки до собственных агентов под конкретный бизнес-процесс.",
  "Работаю с LLM, агентными пайплайнами, retrieval, evals. Преподаю — обучил больше 50 человек, от продактов до операционных команд.",
];
        ...
        >
          <div data-reveal>
            ...
            >
              ...
              магии. В AI с 2022 года, сорок плюс внедрений, больше пятидесяти обученных людей —
              и ни одного пилота, который бы остался пилотом.
            </p>
