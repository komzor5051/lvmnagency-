...
export const metadata: Metadata = {
  ...
  description:
    "Два гайда — по Claude в работе и по контент-конвейеру, консультация 1:1, AI-аудит процессов и мини-курс. Четыре формата под разный масштаб задачи — выбери свой.",
...
const faq = [
  ...
  },
  {
    ...
    a: "Бесплатный — автоматическая анкета: 5 минут и общая карта точек роста. Платный — две недели моей работы: разбираю ваши реальные процессы и данные и отдаю план с расчётом экономии по каждому пункту.",
  },
  {
    // [?] Способы оплаты для аудита — подтвердить.
    q: "Как проходит оплата?",
    a: "Гайды и консультация оплачиваются картой через lava.top. Гайд про Claude приходит сразу после оплаты, ContentOS выдаёт телеграм-бот по ссылке из письма. После оплаты консультации пишете мне в Telegram — согласуем время. По аудиту условия обсуждаем в Telegram до старта.",
  },
  {
    // [?] Формального порядка возврата на сайте нет — сформулировать и вписать.
    q: "Что если задача окажется не моей?",
    a: "Скажу об этом сразу и не возьму проект. Мне невыгодно браться за то, где эффект не просчитывается: такие проекты не работают и не превращаются в кейс.",
  },
  {
      ...
      <section className="bento-section bento-section--hero" id="products">
        <div className="studio-frame">
          <header className="bento-head" data-studio-reveal>
            <p className="bento-mono">Форматы работы / 01—05</p>
            <h1>Что можно заказать и почём</h1>
            <p>
              Пять форматов: два гайда — за 990 ₽ про Claude в работе и за
              2 490 ₽ про контент-конвейер, часовая консультация за 3 850 ₽,
              аудит с планом за 15 000 ₽ и мини-курс, который скоро выйдет.
