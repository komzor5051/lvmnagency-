...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Два гайда, консультация 1:1, сопровождение по 10000 ₽ в месяц, AI-аудит процессов и личная программа на 6 недель.",
    type: "website",
    url: `${siteUrl}/products`,
    locale: "ru_RU",
  },
...
const pick = [
  ...
  },
  {
    ...
    title: "Консультация",
    text: "Час на твою задачу, а не на теорию. Запускаем её в Claude/Codex прямо на созвоне: встреча заканчивается работающей вещью.",
    href: "/products/consultation",
    label: "Забронировать",
  },
  {
...
const start = [
  ...
  { title: "Не хочешь застревать между встречами", text: "сопровождение, 10000 ₽ в месяц." },
...
const faq = [
  {
    title: "Чем аудит за 15000 ₽ отличается от бесплатного на сайте?",
  ...
  },
  {
    ...
    body: "Гайды и консультация оплачиваются картой через lava.top. Гайд про Claude/Codex приходит сразу после оплаты, ContentOS выдаёт телеграм-бот. После оплаты консультации пишешь мне в Telegram, согласуем время. По аудиту условия обсуждаем до старта.",
  },
  {
  ...
  {
    title: "Нужно отдельно платить за Claude/Codex?",
