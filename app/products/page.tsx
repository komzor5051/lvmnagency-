...
export const metadata: Metadata = {
  ...
  description:
    "Два гайда — по Claude в работе и по контент-конвейеру, консультация 1:1, AI-аудит процессов, внедрение под ключ и мини-курс. Пять форматов под разный масштаб задачи — выберите свой.",
  alternates: { canonical: `${siteUrl}/products` },
  openGraph: {
    title: "Продукты — Влад Лямин",
    description:
      "Два гайда, консультация 1:1, AI-аудит процессов, внедрение под ключ и мини-курс по автоматизации.",
    type: "website",
    url: `${siteUrl}/products`,
    locale: "ru_RU",
  },
...
const faq = [
  ...
  },
  {
    ...
    a: "Гайды и консультация оплачиваются картой через lava.top. Гайд про Claude приходит сразу после оплаты, ContentOS выдаёт телеграм-бот по ссылке из письма. После оплаты консультации пишете мне в Telegram — согласуем время. По аудиту и внедрению условия обсуждаем в Telegram до старта.",
  },
  {
