...
export const metadata: Metadata = {
  ...
  description:
    "Два гайда — по Claude в работе и по контент-конвейеру, консультация 1:1, AI-аудит процессов и мини-курс. Пять форматов под разный масштаб задачи — выбери свой.",
