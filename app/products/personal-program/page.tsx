          ...
          <div className="mx-auto max-w-7xl px-5 py-20 md:px-14 md:py-28">
            <div className="grid gap-10 lg:grid-cols-[1fr_1.5fr] lg:gap-16">
              ...
              <div data-m="reveal" className="space-y-4 text-[16px] leading-relaxed text-[#6b6e78]">
                <p>Открываешь Claude/Codex и опять объясняешь, кто ты. Копируешь чужой промпт. Получаешь общий ответ, немного правишь и на следующий день начинаешь заново.</p>
                <p>Статистика Instagram лежит отдельно. Черновики отдельно. Идеи отдельно. Claude/Codex ничего об этом не знает, пока ты снова не перескажешь всё руками.</p>
          ...
          <div className="mx-auto max-w-7xl px-5 py-20 md:px-14 md:py-28">
            <div className="grid gap-14 lg:grid-cols-[1fr_1.4fr] lg:gap-20">
              ...
              <div>
                ...
                <div className="program-copy-plain space-y-3 text-[16px] leading-relaxed text-[#6b6e78]">
                  <p>Четвёртый год я работаю с Claude/Codex каждый день. На нём лежат мой контент, исследования, клиентские проекты и часть операционки.</p>
