...
const cases = [
  ...
  {
    tag: "SaaS / Контент",
    title: "Swipely: AI-генератор каруселей за 20 секунд",
    result: "500+ пользователей, платные подписки",
    task: "SMM-специалисты тратили 1-2 часа на создание одной карусели в дизайн-редакторах",
    solution: "Next.js SaaS + Telegram Mini App: ввод темы → AI пишет тексты → выбор из 12 шаблонов → PNG за 20 секунд",
    detail: "Собственный продукт с оплатой, 517 регистраций",
    days: "Собственный продукт",
  },
  {
    tag: "SaaS / CRM",
    title: "Vsolo: AI-CRM для фрилансеров и соло-предпринимателей",
    result: "7 AI-агентов, полная автоматизация рутины",
    task: "Соло-предприниматели жонглируют 5-10 инструментами: CRM, календарь, документы, аналитика, переписки",
    solution: "React + Supabase: 7 AI-агентов (продажи, контент, бухгалтерия, PM), Google Calendar, Telegram-бот, генерация документов",
    detail: "Всё в одном месте, мультимодельный AI (Gemini/Claude/GPT)",
    days: "Собственный продукт",
  },
];
