...
export function HeroVideoSection() {
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      rafId = requestAnimationFrame(() => {
        ...
        const overlay = document.getElementById("lo-blur-overlay");
        if (overlay) {
          overlay.style.opacity = String(Math.min(progress * 2, 0.9));
        }
      });
    };
  ...
  return (
    <>
      ...
      <div className="lo-video-wrap" aria-hidden="true">
        <video className="lo-video-fixed" autoPlay loop muted playsInline>
          <source
            src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260228_065522_522e2295-ba22-457e-8fdb-fbcd68109c73.mp4"
            type="video/mp4"
          />
        </video>
        {/* Blur + darken scrim — activates as hero recedes */}
        <div id="lo-blur-overlay" className="lo-blur-overlay" />
      </div>
