...
5. Есть минимум 1 ссылка на https://lvmn.vercel.app или https://t.me/lyaminvl? Если нет — вставь естественно.
${IMAGE_PRESERVATION}
Верни ИСПРАВЛЕННУЮ статью целиком в Markdown. Без комментариев.`,
...
ПРОВЕРКА УСЛУГ LVMN:
5. Упоминаются ТОЛЬКО реальные услуги: Telegram-боты с AI, автоматизация бизнес-процессов, AI-сервисы, n8n-воркфлоу.
6. НЕ упоминаются услуги, которых LVMN не оказывает (SEO, контекстная реклама, CRM-настройка, разработка сайтов, консалтинг без внедрения). Если нашёл — удали.
