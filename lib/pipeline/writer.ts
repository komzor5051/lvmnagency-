...
- Используй ТОЧНЫЕ URL из списка, не выдумывай\n`
  ...
  const prompt = `Ты ведёшь блог Влада Лямина — AI-инженера, который внедряет AI-системы для бизнеса. Пишешь от его лица живым русским языком, как практик.
...
ОБЯЗАТЕЛЬНЫЕ ССЫЛКИ:
- Ссылка на сайт: [Влад Лямин](https://lvmn.vercel.app) — вставь естественно, когда к месту
...
4. Секция "Как я это решаю на практике" — конкретный пример из реальных внедрений Влада
